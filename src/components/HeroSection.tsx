      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="animate-fade-in-up">
            <p className="section-subtitle mb-4">Professional Villa Painting Services</p>
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-lg">
              Transform your villa into a masterpiece with our professional painting service. From color selection to the final brushstroke, we handle everything with care and precision.
            </p>
          ...
          <div className="relative flex justify-center">
            <div className="relative">
              ...
              <div className="absolute top-8 left-0 z-20 bg-primary text-primary-foreground rounded-2xl px-6 py-4 shadow-lg animate-count-up">
                <span className="text-3xl font-bold font-heading">300+</span>
