        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-sm opacity-70 leading-relaxed max-w-xs">
              We offer reliable interior and exterior painting with skilled workmanship, premium paints, and smooth finishes that refresh homes and commercial spaces.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-center gap-3 opacity-70">
                ...
                <a href="tel:+971527833727" className="hover:text-primary transition-colors">+971527833727</a>
              </li>
              <li className="flex items-center gap-3 opacity-70">
                <Mail className="w-4 h-4 text-primary flex-shrink-0" />
                <span>dxbpaintingservice@gmail.com</span>
              </li>
              <li className="flex items-start gap-3 opacity-70">
                <MapPin className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <span>France Cluster, International City, Dubai, UAE</span>
              </li>
            </ul>
          </div>
        </div>
